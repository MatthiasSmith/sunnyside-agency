...
const BrandAttribute = ({ imageSrcSet, title, text, isRed, isReversed }) => {
  return (
    <section className='sm:flex'>
      <ResponsiveImage
        className={`sm:w-1/2 ${isReversed ? 'sm:order-2' : 'sm:order-1'}`}
      ...
      >
        <div className='text-center md:text-left max-w-xs mx-auto sm:flex sm:flex-col sm:justify-center sm:items-center sm:h-full'>
